...
public class Channel extends BaseData {
    ...
    static public class Resource extends ResourceBase {
        ...
        public String create(final Channel channel) throws ScgException {
            ...
            return ExecuteWithRetry(() -> Session.Execute(channelApi_.create(channel)).id, 0);
        }

        public boolean update(final Channel channel) throws ScgException {

            ExecuteWithRetry(() -> Session.Execute(channelApi_.update(channel.getId(), channel)), 0);
            return true;
        }
        ...
        public Channel get(final String id) throws ScgException {
            return ExecuteWithRetry(() -> Session.Execute(channelApi_.get(id)), 0);
        }
        ...
        public ItemItetaror<Channel> list(Map<String, String> options) throws ScgException {
            return genericList(
                options,
                null,
                opts -> ExecuteWithRetry(() -> Session.Execute(channelApi_.list(opts)), 0));
        }
        ...
        public ItemItetaror<Channel> list(Map<String, String> options,
            ...
            return ExecuteWithRetry(() -> genericList(options, parameters, opts -> Session.Execute(channelApi_.list(opts))), 0);
        }
        ...
        public boolean delete(final String id) throws ScgException {
            ExecuteWithRetry(() -> Session.Execute(channelApi_.delete(id)), 0);
            return true;
        }
    }
}
