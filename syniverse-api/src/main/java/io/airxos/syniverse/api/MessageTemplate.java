...
public class MessageTemplate extends BaseData {
    ...
    static public class Resource extends ResourceBase {
        ...
        public String create(final MessageTemplate messageTemplate) throws ScgException {
            return ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.create(messageTemplate)).id, 0);
        }

        public boolean update(final MessageTemplate messageTemplate) throws ScgException {
            ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.update(messageTemplate.getId(), messageTemplate)), 0);
            return true;
        }
        ...
        public MessageTemplate get(final String id) throws ScgException {
            return ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.get(id)), 0);
        }
        ...
        public ItemItetaror<MessageTemplate> list(Map<String, String> options) throws ScgException {
            return genericList(options, null, opts -> ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.list(opts)), 0));
        }
        ...
        public ItemItetaror<MessageTemplate> list(Map<String, String> options,
            ...
            return genericList(
                options,
                parameters,
                opts -> ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.list(opts)), 0));
        }
        ...
        public boolean delete(final String id) throws ScgException {
            ExecuteWithRetry(() -> Session.Execute(messageTemplateApi_.delete(id)), 0);
            return true;
        }
    }
}
