...
public class Bridge extends BaseData {
    ...
    static public class Resource extends ResourceBase {
        ...
        public String create(final Bridge bridge) throws ScgException {
            ...
            return ExecuteWithRetry(() -> Session.Execute(bridgeApi_.create(bridge)).id, 0);
        }
        ...
        public boolean update(final Bridge bridge) throws ScgException {
            ...
            ExecuteWithRetry(() -> Session.Execute(bridgeApi_.update(
                    bridge.getId(),
                    bridge)), 0);
            return true;
        }
        ...
        public Bridge get(final String id) throws ScgException {
            return ExecuteWithRetry(() -> Session.Execute(bridgeApi_.get(id)), 0);
        }
        ...
        public ItemItetaror<Bridge> list(Map<String, String> options) throws ScgException {
            return genericList(
                options,
                null,
                opts -> ExecuteWithRetry(() -> Session.Execute(bridgeApi_.list(opts)), 0));
        }
        ...
        public ItemItetaror<Bridge> list(Map<String, String> options,
            ...
            return ExecuteWithRetry(() -> genericList(options, parameters, opts -> Session.Execute(bridgeApi_.list(opts))), 0);
        }
        ...
        public boolean delete(final String id) throws ScgException {
            ExecuteWithRetry(() -> Session.Execute(bridgeApi_.delete(id)), 0);
            return true;
        }
    }
